  ...
  return (
    <>
      <form onSubmit={formik.handleSubmit} className="max-w-md mx-auto p-4">
        ...
        <button
          type="submit"
          className="m-auto text-white bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm w-full px-5 py-3 dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800"
        >
          Register
        </button>
      </form>
